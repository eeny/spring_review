        ...
        <main>
            ...
            <div class="main-section">
                ...
                <section class="main-right">
                    <!--게시판 본문 시작-->
                    <h1><i class="far fa-file-alt"></i> 게시판관리 <i class="fas fa-angle-right"></i> 게시판 생성</h1>
                    ...
                    <h1><i class="far fa-file-alt"></i> 게시판 관리 <i class="fas fa-angle-right"></i> 게시판 목록</h1>
