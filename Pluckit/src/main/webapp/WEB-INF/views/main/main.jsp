		...
		<main>
			<div class="main-top">
				...
				<div class="user-name">
					...
					<c:if test="${empInfo eq null }">
						<p>
							<i class="fas fa-user-circle"></i>&nbsp;손님 [권한 : 0]
						</p>
					</c:if>
				</div>
				...
				<div class="main-top-icon">
					...
					<i class="fas fa-bullhorn"></i> <i class="fas fa-home" onclick="location.href='Home.do'"></i>
					<c:if test="${empInfo ne null }">
			...
			<div class="main-section">
				...
				<section class="section-left">
					...
					<div class="btn-G">바로가기 버튼 모음</div>
				</section>

				<section class="section-right">
					<div class="section-right-top">
						<div class="section-right-top-left">업무공유</div>
						<div class="section-right-top-right">일정공유(달력)</div>
					</div>

					<div class="section-right-bottom">공지사항</div>
				</section>
			</div>
			<!-- 메인 페이지 끝 -->
		</main>
